<?php
/**
 * The template for displaying "Header 2"
 *
 * @package WordPress
...
if (empty($logo_image)) 
	$logo_image = room_get_theme_option( 'logo_2' );
if (empty($logo_image))
		...
		<div class="logo">
			<a href="<?php echo esc_url(home_url('/')); ?>"><?php
				if (!empty($logo_image)) {
					...
					echo '<img src="'.esc_url($logo_image).'" class="logo_main" alt=""'.(!empty($attr[3]) ? ' '.trim($attr[3]) : '').'>' ;
				} else {
